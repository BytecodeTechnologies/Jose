...
namespace NewJersyTrafficTicket.Capcha
{
    public class CaptchaImage
    {
        ...
        public void GenerateImage()
        {
            ...
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.Shingle, ColorTranslator.FromHtml("#F6BA18"),  ColorTranslator.FromHtml("#F6BA18"));
            ...
            // Draw the text.
            hatchBrush = new HatchBrush(HatchStyle.Shingle, ColorTranslator.FromHtml("#12a0b1"), ColorTranslator.FromHtml("#12a0b1"));
